...
const UserProfile = () => {
    ...
    useEffect(()=>{
        ...
        fetchUserDetails(payload).then((res)=>{
            dispatch(actionsCreator.SET_USER_DETAILS(res.data.data))
                    ...
                    <div className="prodetails">
                       ...
                       <div className="DOB">
                        ...
                        <div className="ContactNumber">
                            <h3>ContactNumber</h3>
                            <h4 id="Contactnumber">{auth?.userDetails?.contactNumber}</h4>
                        </div>
                        ...
                        <div className="Aboutme">
                            <h3>About Me</h3>
                            <p id="aboutme">{auth?.userDetails?.bio}</p>
                        </div>
                    </div>
